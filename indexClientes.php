...
<head>
	...
	$.ajax({
		data:{usuario:usuario.val(),pass:pass.val(),'Action':'OK'},
		url:"back/Login.php",
		type:"POST",
...
<body>
    <h1 style='color: #164194;font-weight: bold;  font-family:"Palatino", sans-serif;padding: 2% !important'>Lumens<br>Inicio De Sesión</h1>
