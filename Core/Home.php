...
$agentes=0;
//$consulta="SELECT count(*) FROM agentes a inner join usuarios u on u.usuario=a.usuario WHERE a.codempresa='".$_SESSION['LMNS-USER_CODE']."' and u.estado='Activo' "; 
...
//fecha>= DATE_ADD(CURDATE(),INTERVAL -17 DAY) and codempresa='".$_SESSION['LMNS-USER_CODE']."' GROUP BY fecha"; 
$consulta=" SELECT fecha, SUM(cantidad), SUM(efectivos), SUM(noefectivos) FROM actividad WHERE 
fecha >= DATE_ADD( CURDATE(), INTERVAL -7 DAY) GROUP BY fecha ";
 $datos=mysqli_query($mysqli,$consulta);      
            ...
            <div class="col-md-4 content-top-2 card widget" style="width: 51% !Important">
        		<div class="r3_counter_box">
                    ...
                    <i class="pull-left fa fa-star" style="font-size: 50PX"></i>
                     ¡Bienvenido  a Lumens!
					<br><b><?php echo  $_SESSION['LMNS-USER_NOMBRE'];?></b></h2>
