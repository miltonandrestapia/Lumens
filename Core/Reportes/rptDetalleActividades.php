<?php
	...
	$filename = "Detalleactividad_".$_GET["CodActividad"].".xls"; 
	...
	if($_GET["codclient"]!=""){
			$completa=" and p.codcliente='".mysqli_real_escape_string($mysqli,$_GET["codclient"])."' ";
	}
...
WHERE 
     ac.cons='".mysqli_real_escape_string($mysqli,$_GET["CodActividad"])."' ".$completa." ORDER BY ac.cons  "; 
