...
WHERE  ac.cons=".mysqli_real_escape_string($mysqli,$cons)."  ORDER BY ac.cons limit 36 ";
...
$cons8=0;
    ...
    for($b=0;$b<$row_CantidadRegistro;$b++){
      ...
      <table cellpadding="5" cellspacing="2" align="center" style="width:98%;margin:auto;">
     <tr >  
       ...
       <td style="width:50% !important"> 
 				...
 				<table    align="center" style="margin:auto;">
					<tr >      
						<td style="width:100% !important" colspan="2"> 
									<div class="codbarra"  style="text-align:center;width:100%;margin-bottom:10px;margin-top:5px;" >*'.$consecutivo.'*</div>
				...
				<tr >     
					 <td   valign="top" style="width:80% !important">  
  ...
  ';
     ...
     $tbl.='</tr>';
          ...
          $cons6++;
           ...
           $agente=$parte7[$parte7]['agente'];
           $producto=$parte7[$parte7]['producto'];
             $orden=$parte7[$parte7]['orden'];
           $consecutivo=$parte7[$parte7]['consecutivo']; 
           $cuenta= $parte7[$parte7]['cuenta'];
           $idventa=$parte7[$parte7]['idventa'];
           $direccion=$parte7[$parte7]['direccion'];
           $cuadratula=$parte7[$parte7]['cuadralatura'];
           $ciclo=$parte7[$parte7]['ciclo'];
           $suscriptor=$parte7[$parte7]['suscriptor'];
           $grupo=$parte7[$parte7]['grupo'];
           $sucursal=$parte7[$parte7]['sucursal'];
           $f_llegada=$parte7[$parte7]['fechallegada'];
           $f_entrega=$parte7[$parte7]['fechaentrega'];
           $cedula=$parte7[$parte7]['cedula'];
           $especial1=$parte7[$parte7]['especial'];
           $lote= $parte7[$parte7]['lote'];
