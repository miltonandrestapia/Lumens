...
<link rel="stylesheet" type="text/css" href="Ext/jquery.dataTables.css">
 <script type="text/javascript">
   ...
   var Empresas="<?php //echo $_SESSION['LMNS-USER_CODE'];?>";
 var codigoc='';
...
$('#btng').button('loading');  
    ...
    //data:{nombre:nombre,nit:nit,fechai:fechai,Contacto:Contacto,Telefono:Telefono,correo:correo,estado:estado,observaciones:observaciones,Pass:Pass,Usuario:Usuario,Empresas:Empresas,Departamento:Departamento,'Ingresar':'OK'},
    data:{nombre:nombre,nit:nit,fechai:fechai,Contacto:Contacto,Telefono:Telefono,correo:correo,estado:estado,observaciones:observaciones,Pass:Pass,Usuario:Usuario,Departamento:Departamento,unidadNeg:unidadNeg,'Ingresar':'OK'},
     url:"Procesamiento/MdlCliente.php",
     type:"POST",    
...
function listar(){
    ...
    var Datos = {
        "Listar" : '<?php echo "OK";// echo $_SESSION['LMNS-USER_CODE'];?>' ,
...
$('#btna').button('loading');
    ...
    data:{nombre:nombre,nit:nit,fechai:fechai,Contacto:Contacto,Telefono:Telefono,correo:correo,estado:estado,observaciones:observaciones,codigoc:codigoc,Pass:Pass,Usuario:Usuario,Departamento:Departamento,unidadNeg:unidadNeg,'Actualizar':'OK'},
     url:"Procesamiento/MdlCliente.php",
     type:"POST",
     success:function(resp){    
  ...
  $.ajax({
        ...
        success:function(resp){
            ...
            if (resp[0]=='s'){
                 ...
                 codigoc=resp[9];
                 $("#Usuario").val(resp[10]);
                 $("#Departamento").val(resp[11]);   
                 $("#unidadNeg").val(resp[12]);  
                $("#Pass").val(resp[13]);          
                 $("#home-tab").click();
                 $("#btng").hide();
                 $("#btna").show();
...
<div class="col-md-12  widget-shadow">
                    ...
                    <div role="tabpanel" class="tab-pane fade  active in" id="home" aria-labelledby="home-tab"> 
                        ...
                        <div class="panel panel-primary"> 
                            <div class="panel-heading"  style="background-color: #222D32 !important"> 
                                <h3 class="panel-title">Lumens | Clientes Formulario</h3> 
                            </div> 
                            <div class="panel-body" style="background-color: #fafafa"> 
                                        ...
                                        <div class="single-bottom row" >
                                                        <!-- ROW -->
                                                        <div class="col-md-4">
                                                            <p><i class="fa fa-user-o"></i> Nombre Cliente </p>
                                                        ...
                                                        <div class="col-md-4">
                                                            <p><i class="fa fa-calendar-check-o"></i> Fecha Inicio Operaciones</p>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab"> 
                            <p>
                                    ...
                                    <div class="panel panel-primary"> 
                                        <div class="panel-heading"  style="background-color: #222D32 !important"> 
                                            <h3 class="panel-title">Lumens |  Clientes Listado</h3> 
                                        </div> 
                                        <div class="panel-body" style="background-color: #fafafa"> 
                                                <div class="single-bottom row" >
