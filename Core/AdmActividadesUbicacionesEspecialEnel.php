...
require_once("Procesamiento/Conexion.php");
      ...
      $consulta="SELECT lat,lon,nombre,fechageo,cons FROM agentes WHERE  usuario IN (SELECT DISTINCT codagente FROM proyectoespecialenel WHERE codactividad='".mysqli_real_escape_string($mysqli,$_GET["cod"])."') and  not fechageo is null "; 
