...
$coordenadas="";
        ...
        $consulta="SELECT  latitud,longitud,fecharealizado,direccion FROM proyectoespecialenel WHERE 
     codagente='".mysqli_real_escape_string($mysqli,$_GET["agente"])."' 
     AND codactividad='".mysqli_real_escape_string($mysqli,$_GET["cod"])."' and not estado='Pendiente' ORDER BY fecharealizado ASC"; 
