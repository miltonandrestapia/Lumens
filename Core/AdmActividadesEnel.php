...
testwindow1 = window.open("Progreso.php?action=Proceso_Carga&archivo="+nombre+"&Cantidad="+cantidad, "Progreso", "location=0,status=0,scrollbars=0,width=800,height=200");
