...
$('#btng').button('loading');
    ...
    data:{nombre:nombre,nit:nit,fechai:fechai,Contacto:Contacto,Telefono:Telefono,correo:correo,estado:estado,usuario:usuario,contrasena:contrasena,observaciones:observaciones,'Ingresar':'OK'},
...
$('#btna').button('loading');
    ...
    data:{nombre:nombre,nit:nit,fechai:fechai,Contacto:Contacto,Telefono:Telefono,correo:correo,estado:estado,usuario:usuario,contrasena:contrasena,observaciones:observaciones,codigoc:codigoc,'Actualizar':'OK'},
     url:"Procesamiento/MdlCliente.php",
     type:"POST",
     success:function(resp){    
